...
def process_data(data):
  ...
  for item in data:
    ...
    # use dictionary to hold total sales for each year, add total_sales from each item 
    # to matching year-key value
    year = item["car"]["car_year"]
    sales = item["total_sales"]
    if year in sales_year:
  ...
  popular_year = 0
  max_year_sales = 0
  for year, total_sales in sales_year.items():
    if total_sales > max_year_sales:
